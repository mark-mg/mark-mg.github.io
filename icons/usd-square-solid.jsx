<svg className="svg-inline--fa fa-usd-square fa-w-14" height={this.props.height} role="img" width={this.props.width} viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" data-prefix="fas" data-icon="usd-square">
